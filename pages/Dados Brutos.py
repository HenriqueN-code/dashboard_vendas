...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button('Fazer o download do arquivo em csv', data=converte_csv(dados_filtrados),file_name=nome_arquivo,mime='text/csv',on_click=mensagem_sucesso)
