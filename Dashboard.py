...
venda_mensal = dados.set_index('Data da Compra').groupby(pd.Grouper(freq='M'))['Preço'].sum().reset_index()
...
with aba2:
    ...
    with col1:
        ...
        fig_venda_estados = px.bar(vendas_estado.head(),
                             x = 'Local da compra',
                                            y = 'Preço',
                                            text_auto = True,
                                            title = 'Top 5 estados')
        fig_receita_estados.update_layout(yaxis_title = 'Quantidade de Vendas')
    ...
    with col2:
        ...
        fig_venda_categoria = px.bar(vendas_categoria,
                                     text_auto= True,
                                     title= 'Vendas por Categoria')
        st.plotly_chart(fig_venda_categoria, use_container_width = True)
